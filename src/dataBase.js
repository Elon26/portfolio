const works = [
    ...
    },
    {
        ...
        stack: "JavaScript",
        repository: "https://github.com/Elon26/comments",
        deploy: "https://elon26.github.io/comments/",
        video: "",
        description: "Проект представляет собой страницу блога с возможностью комментирования, реализовнную на чистом JavaScript. Поля формы содержат базовую валидацию вводимых значений. Также предусмотрено преобразование введённых пользователем данных с целью приведения к унифицированному виду для последующего хранения в базе данных. Более подробное описание проекта и всего содержащегося в нём функционала представлено в файле Readme в репозитории."
    },
    {
        id: "dfgd32432dsf3wq4",
        name: "Todo-лист",
