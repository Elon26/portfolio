const works = [
    {
        ...
        description: "Опубликованная версия интернет-магазина содержит тестовую базу данных, состоящую из 4 категорий, 16 подкатегорий и 160 товаров, также в данной версии исключён функционал оплаты товара, в остальном представленная версия полностью соответствует рабочей. В проекте реализованы следующие страницы - Главная, Страница категории, Страница подкатегории, Страница товара, Корзина, Страница авторизации/регистрации и Страница администратора. Для доступа на страницу администратора, где настроен функционал создания, редактирования и удаления товаров, используйте логин admin@bk.ru и пароль Admin@2612 (более подробное описание приложения представлено в Readme-файле репозитория)."
    },
    {
